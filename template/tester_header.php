    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav">
          ...
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="bug">
            <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapsebug">
              <i class="fa fa-fw fa-bug"></i>
              <span class="nav-link-text">
                bug</span>
            </a>
             <ul class="sidenav-second-level collapse active" id="collapsebug">
              
              <li>
                <a href="bug_list_tester.php">Update bug</a>
              </li>
              <li>
                <a href="view_bug_list.php">View bugs</a>
              </li>
            </ul>
          </li>
