...
<ol class="breadcrumb">
  ...
  <td>
    <button <?php if($row['bug_status']=="completed"){echo 'disabled';} ?> type="button" class="btn btn-sm btn-primary float-right followupbutton" data-toggle="modal" data-target="#followupmodal" data-id="<?php echo $bug_id; ?>">New follow up message</button>
  </td>
</ol>
    ...
    <div class="row">
      <div class="table-responsive table-hover col-sm-6">
        <table class="table table-bordered align-self">
          ...
          <?php if(!($_SESSION['login_user_type']=='Developer'&&$row['bug_status']=='completed')){ ?>
            <tr>
              ...
              <td>
                <form action="action/update_bug_status.php" method="POST">
                  ...
                  <select name="inputBugStatus">
                    ...
                    <option value="resolving"><?php echo "Resolving"; ?></option>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-hover" width="100%" id="dataTable" cellspacing="0">
                ...
                <tr>
                  ...
                  <td class="bg-light"><?php echo $row_bug['follow_up_msg']; ?></td>
